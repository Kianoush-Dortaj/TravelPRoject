...
import { DiscountDataSource } from '../../services/discount-datasource.service';
...
export class ListComponent implements OnInit {
  ...
  columnsToDisplay = ['more', 'name','numberOfUse', 'percent','startDate','expireDate', 'actions'];
  ...
  constructor(
    private managerService: DiscountService
  ...
  dataSourceInit(): void {
    this.dataSource = new DiscountDataSource(this.managerService);
    this.dataSource.loadDiscounts(1, this.pageSize, this.filters);
  }
  ...
  sortData(sort: Sort) {
    ...
    this.dataSource.discount$.subscribe(x => {
      this.seedData = x
    })
    ...
    this.dataSource.discountSubject.next(data);
  }
}
