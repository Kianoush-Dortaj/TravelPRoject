...
export class FiltersComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, private travelTypeService: TravelTypeResidenceService) { }
  ...
  loadFilters(): void {
    this.travelTypeService.updateFilter(this.MakeFiltersForTable(this.f))
  }
