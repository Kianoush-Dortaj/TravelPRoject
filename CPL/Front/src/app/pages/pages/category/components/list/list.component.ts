...
import { CategoryDataSource } from '../../services';
...
export class ListComponent implements OnInit {
  ...
  constructor(
    private managerService: CategoryService
  ...
  dataSourceInit(): void {
    this.dataSource = new CategoryDataSource(this.managerService);
  ...
  sortData(sort: Sort) {
    ...
    this.dataSource.category$.subscribe(x => {
      this.seedData = x
    })
    ...
    this.dataSource.categorySubject.next(data);
  }
}
