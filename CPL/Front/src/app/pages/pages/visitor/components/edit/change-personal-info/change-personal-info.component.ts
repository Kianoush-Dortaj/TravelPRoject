  ...
  constructor(private formBuilder: FormBuilder
    ...
    ngOnInit(): void {
      ...
      if (this.personalInfo.hasAvatar) {
        this.imgURL = this.appConfig.apiEndpoint + '/admin/Manager/GetManagerImage/' + this.personalInfo.id + '/?access_token=' + this.authService.getRawAuthToken(AuthTokenType.AccessToken);
      } else {
    ...
    saveInfo() {
     ...
     this.subscription= this.userService.UpdateWithFile(editModel, this.personalInfo.id, '/admin/visitor/UpdateInforamtion').subscribe(
