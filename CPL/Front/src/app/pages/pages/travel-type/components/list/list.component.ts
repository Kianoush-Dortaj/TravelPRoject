...
import { TravelTypeDataSource } from '../../services/travel-type-datasource.service';
...
export class ListComponent implements OnInit {
  ...
  dataSource: TravelTypeDataSource;
  ...
  constructor(
    private managerService: TravelTypeService
  ...
  dataSourceInit(): void {
    this.dataSource = new TravelTypeDataSource(this.managerService);
  ...
  delete(id: number): void {
    ...
    const dialogRef = this.dialog.open(DeleteEntityDialogComponent, {
      data: { id, title, itemName, service, url: '/category/Delete' },
      width: '440px'
    });
  ...
  sortData(sort: Sort) {
    ...
    this.dataSource.travelType$.subscribe(x => {
      this.seedData = x
    })
    ...
    this.dataSource.travelTypeSubject.next(data);
  }
}
