...
import { ManagersDataSource, ManagersService } from '../../services';
...
export class ListComponent implements OnInit {
  ...
  dataSourceInit(): void {
    this.dataSource = new ManagersDataSource(this.managerService);
    this.dataSource.loadManagers(1, this.pageSize, this.filters);
  }
  ...
  sortData(sort: Sort) {
    ...
    this.dataSource.managers$.subscribe(x => {
      this.seedData = x
    })
    ...
    this.dataSource.managersSubject.next(data);
  }
}
