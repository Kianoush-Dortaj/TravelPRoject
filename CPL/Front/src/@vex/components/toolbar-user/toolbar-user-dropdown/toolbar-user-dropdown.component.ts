...
import { AuthService, BrowserStorageService } from 'src/app/core/auth/services';
...
export class ToolbarUserDropdownComponent implements OnInit {
  ...
  constructor(private cd: ChangeDetectorRef,
    ...
    private translateLanguage:TranslationService,
    private styleService: StyleService,
    private popoverRef: PopoverRef<ToolbarUserDropdownComponent>) {
      this.displatyName=this.browserStorageService.getDisplayName();
  ...
  ngOnInit() {
    this.translateLanguage.currentLang$.subscribe(data=>{
